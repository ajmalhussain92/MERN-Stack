...
import {Trash, Save, NotebookPen} from 'lucide-react';

const NotesCard = ({note, id, deleteNote, editNote}) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-64 h-64 bg-gray-800 rounded-lg shadow-lg p-4 m-4">
      ...
      <div className="flex justify-between w-full bg-purple-600 rounded-lg p-2 mt-2">
        ...
        <button className="text-blue-500 hover:text-blue-600" onClick={()=>editNote(id)}><NotebookPen/></button>
        <button className="text-green-300 hover:text-green-500" onClick={handleDownload}><Save/></button>
      </div>
